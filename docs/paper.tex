...
% Para 4: 제안하는 방법 개요
In this work, we propose a noise-conditioned speech enhancement framework that explicitly leverages noise characteristics through Classifier-Free Guidance (CFG)~\cite{ho2022classifier}.
