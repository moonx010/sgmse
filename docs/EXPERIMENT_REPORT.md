...
|-------|--------|---------|----------|
| Baseline (old code) | 1.59 ± 0.42 | 0.68 ± 0.16 | 10.1 ± 4.3 |
| **Baseline (p=0.0, same code)** | **1.81 ± 0.53** | **0.73 ± 0.17** | **11.1 ± 4.7** |
...
| Model | PESQ ↑ | ESTOI ↑ | SI-SDR ↑ |
|-------|--------|---------|----------|
| Baseline (old code) | 1.12 ± 0.17 | 0.42 ± 0.23 | -1.4 ± 3.4 |
| **Baseline (p=0.0, same code)** | **1.15 ± 0.23** | **0.47 ± 0.21** | **-0.4 ± 2.2** |
